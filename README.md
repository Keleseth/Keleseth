...
I'm a Python backend developer focused on building reliable, clean, and scalable web services.

I work with **FastAPI**, **Django**, **PostgreSQL**, **SQLAlchemy**, and **Telegram bots**, using tools like **Docker**, **Alembic**, and **GitHub Actions**.
...
- **📊 PEP Parser**  
  ...
  [Repository →](https://github.com/Keleseth/scrapy_parser_pep)
